...
```text
$ktt 해커 https://example.com/article-about-ai-tools
```
...
| 페르소나 | 이런 글에 좋음 |
|---|---|
| `실무자` | 운영, 비용, 장애, 실패 복구, 유지보수 |
| `해커` | 도구 조합, 자동화, 빠른 실험, 비용 절감 |
...
flowchart LR
    ...
    B --> C{"페르소나"}
    C --> D["thread-practitioner.md"]
    C --> E["thread-hacker.md"]
    D --> F["한국어 테크 스레드"]
    E --> F
```
...
| `thread-practitioner.md` | `실무자` 말투 |
| `thread-hacker.md` | `해커` 말투 |
